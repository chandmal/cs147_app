...
$returnURL = "http://stanford.edu/~holstein/cgi-bin/dev/cs147_app/requests/accept_request2.php?redirect=confirm&id=".$_GET['request_id'];
$cancelURL = "http://stanford.edu/~holstein/cgi-bin/dev/cs147_app/requests/new2.php";
