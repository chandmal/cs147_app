...
$request_type = $_SESSION['user_type'] == "driver" ? "driver_to_rider" : "rider_to_driver";
...
mysql_query("INSERT INTO requests (request_type, to_user, from_user, ride_id, confirmed) VALUES ('$request_type', $to_user, $from_user, $ride_id, $confirmed)");
echo mysql_error();
