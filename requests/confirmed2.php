...
?>
                        <li>
                            <a href="new2.php" data-theme="" rel="external" <?= $data_icon ?>>
                                Requests
                            </a>
                        </li>
                        <li>
                            <a href="pending2.php" data-theme="" rel="external">
                                Pending
                            </a>
                        </li>
                        <li>
                            <a class="ui-btn-active ui-state-persist" href="confirmed2.php" data-theme="" rel="external" class="ui-btn-active ui-state-persist">
                                Confirmed
                            </a>
                        </li>
                    </ul>
		...
		function getRequests() {
			...
			$.get('get_confirmed_requests.php', function(requests) {
				...
				if(requests.length == 0) {
					...
					var initial_theme = "a";
					var button = $('<a data-mini="true" rel="external" href="../map/app2.php" data-role="button" class="ui-content" data-position-to="window" data-theme="' + initial_theme + '">' + caption + '</a>');
