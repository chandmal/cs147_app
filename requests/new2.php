        ...
        <div data-role="page" id="page1">
                ...
                <div data-role="navbar">
                    <ul>
                        <li style="padding-right: 0; padding-left:0">
                            <a href="new2.php" data-ajax="false" class="ui-btn-active ui-state-persist">
                                Requests
                            </a>
                        </li>
                        <li>
                            <a style="padding-right: 0; padding-left:0" class="" href="pending2.php" data-theme="" data-ajax="false">
                                Pending
                            </a>
                        </li>
                        <li>
			...
			if($num_new_requests > 0) {
				...
				?>
                            ...
                            <a style="padding-right: 0; padding-left:0" href="confirmed2.php" data-theme="" data-ajax="false" <?= $data_icon ?>>
                                Confirmed
                            </a>
                        </li>
                    </ul>
		...
		function getRequests() {
			...
			$.get('get_to_you_requests.php', function(requests) {
				...
				if(requests.length == 0) {
					...
					var initial_theme = "a";
					var button = $('<a data-ajax="false" href="../map/app2.php" data-role="button" class="ui-content" data-position-to="window" data-theme="' + initial_theme + '" data-mini="true" >' + caption + '</a>');
